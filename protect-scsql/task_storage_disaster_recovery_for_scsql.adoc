...
.开始之前
* 确保插件处于维护模式。
* 中断 SnapMirror/SnapVault 关系。
link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.onc-sm-help-950/GUID-8A3F828F-CD3D-48E8-A171-393581FEB2ED.html["中断 SnapMirror 关系"]
...
+
有关详细信息，请参阅 https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["《 SnapCenter 软件 cmdlet 参考指南》"^]。
