...
+
有关可与 cmdlet 结合使用的参数及其说明的信息，可通过运行 get-help _command_name_ 来获取。或者、您也可以参考 https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["《 cmdlet 参考指南》"^]
...
** Linux：_/var//opt/linux/SCC/ALLOED_commands.config SnapCenter
