...
image::../media/sce_backup_workflow.gif[Exchange Server数据库备份工作流]

您也可以手动或在脚本中使用 PowerShell cmdlet 执行备份，还原和克隆操作。SnapCenter cmdlet帮助或包含有关PowerShell cmdlet的 https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["《 SnapCenter 软件 cmdlet 参考指南》"^] 详细信息。
